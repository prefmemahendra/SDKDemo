# #
# #  Be sure to run `pod spec lint MyFrameworkFinal.podspec' to ensure this is a
...
#   spec.name         = "MyFrameworkFinal"
#   spec.version      = "0.0.1"
#   spec.summary      = "A short description of MyFrameworkFinal."
...
#   spec.homepage     = "http://EXAMPLE/MyFrameworkFinal"
...
#   spec.author             = { "Mahendra Rajput" => "mahendra.rajput@prefme.com" }
#   # Or just: spec.author    = "Mahendra Rajput"
#   # spec.authors            = { "Mahendra Rajput" => "mahendra.rajput@prefme.com" }
#   # spec.social_media_url   = "https://twitter.com/Mahendra Rajput"
...
#   spec.source       = { :git => "http://EXAMPLE/MyFrameworkFinal.git", :tag => "#{spec.version}" }
